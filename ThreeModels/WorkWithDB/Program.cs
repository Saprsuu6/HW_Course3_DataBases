...
namespace WorkWithDB
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    "01:00",
            //    5);
            //workWithContext.AddQuest(quest);

            //List<Quest> quests = workWithContext.GetQuests();
            //quests[0].Name = "My new quest";
            //workWithContext.UpdateQuest(quests[0]);

            //List<Quest> quests = workWithContext.GetQuests();
            //workWithContext.RemoveQuest(quests[0]);

            //Client client = new Client("Andry", "Saprigin", "Comrax25524", "Cormax25524");
            //workWithContext.AddClient(client);

            //List<Client> clients = workWithContext.GetClients();
            //clients[0].Password = "Cormax12345";
            //clients[0].Password2 = "Cormax12345";
            //workWithContext.UpdateClient();

            //List<Client> clients = workWithContext.GetClients();
            //workWithContext.RemoveClient(clients[0]);
        }
    }
}
